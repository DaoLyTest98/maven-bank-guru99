...
public class CommonPageUI {
	...
	public static final String DYNAMIC_MESSAGE= "xpath=//td[contains(text(),'%s')]/following-sibling::td/label";
	...
	public static final String TITLE_TEXT = "xpath=//p[@class='heading3']";
}
